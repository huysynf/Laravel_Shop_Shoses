            ...
            <form action="{{route('products.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 col-lg-6 col-sm-12">
                        ...
                        <input type="text" class="form-control " name="product_key" value="{{old('product_key')??$product->product_key}}"
                        >
                        @error('product_key')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm 12 ">
                        ...
                        <img src="{{asset('images/products/'.$product->image)}}" alt="" width="100px" height="100px"
                             style="max-height: 100%;max-width: 100%;border: 1px solid" class="image-show student-image">
